...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/HomeStackNav` | `/HomeStackNav` | `/(tabs)/HomeTeacherStackNav` | `/HomeTeacherStackNav` | `/(tabs)/tabNavigation` | `/tabNavigation` | `/Login` | `/screens/Albums` | `/screens/Chat` | `/screens/chatRoom` | `/screens/contactBook` | `/screens/DinhDuong` | `/screens/Home` | `/screens/` | `/screens/LichHoc` | `/screens/Prices` | `/screens/Settings` | `/screens/Teacher/contactBookTeacher` | `/screens/Teacher/hocSinh` | `/screens/Teacher/homeTeacher` | `/screens/Teacher/lichHocTeacher` | `/screens/Teacher/selectStudent` | `/screens/Teacher/selectStudentInfo` | `/screens/Teacher/studentInfo` | `/screens/Teacher/xinNghi` | `/screens/test` | `/screens/Transaction` | `/screens/XinNghi` | `/SignIn` | `/wellcome` | `/_layout`;
  // prettier-ignore
