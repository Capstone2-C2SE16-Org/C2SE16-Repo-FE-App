...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/HomeStackNav` | `/HomeStackNav` | `/(tabs)/tabNavigation` | `/tabNavigation` | `/Login` | `/screens/Albums` | `/screens/Chat` | `/screens/chatRoom` | `/screens/contactBook` | `/screens/DinhDuong` | `/screens/Home` | `/screens/` | `/screens/LichHoc` | `/screens/Prices` | `/screens/Settings` | `/screens/test` | `/screens/Transaction` | `/screens/XinNghi` | `/SignIn` | `/wellcome` | `/_layout`;
  // prettier-ignore
